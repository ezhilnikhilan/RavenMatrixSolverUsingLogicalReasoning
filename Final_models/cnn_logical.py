...
#         print(pred.shape,target.shape)
        loss = F.cross_entropy(pred, target) + r_loss*0.15 #+ rows_and_true*0.5
        return loss
...
#         print(image_features.shape)
        row1 = self.logic_and(image_features[:,0],image_features[:,1])
        constraints.append(row1)
        true_constraints.append(row1)
        row1 = self.logic_and(row1,image_features[:,2])
        constraints.append(row1)
        true_constraints.append(row1)
        row2 = self.logic_and(image_features[:,3],image_features[:,4])
        constraints.append(row2)
        true_constraints.append(row2)
        row2 = self.logic_and(row2,image_features[:,5])
        constraints.append(row2)
        true_constraints.append(row2)
        row3_partial  = self.logic_and(image_features[:,6],image_features[:,7])
        constraints.append(row3_partial)
        row1_row2 = self.logic_and(row1,row2)
        constraints.append(row1_row2)
        row3 = self.logic_and(row3_partial,image_features[:,8])
        constraints.append(row3)
        choice1 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,9])
        constraints.append(row3)
        choice2 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,10])
        constraints.append(row3)
        choice3 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,11])
        constraints.append(row3)
        choice4 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,12])
        constraints.append(row3)
        choice5 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,13])
        constraints.append(row3)
        choice6 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,14])
        constraints.append(row3)
        choice7 = self.logic_and(row1_row2,row3)
        row3 = self.logic_and(row3_partial,image_features[:,15])
        constraints.append(row3)
        choice8 = self.logic_and(row1_row2,row3)
...
#         print(prediction_c1.shape)
        ...
        score = torch.hstack((prediction_c1,prediction_c2,prediction_c3,prediction_c4,prediction_c5,prediction_c6,
                             prediction_c7,prediction_c8)) 
